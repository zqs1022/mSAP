...
f=fopen('./mat/tmp_files/tmp.pgm','w');
if(f==-1)
    error('Could not create file ./mat/tmp_files/tmp.pgm.');
end
fprintf(f,'P5\n%d\n%d\n255\n',cols,rows);
...
command=[command ' <./mat/tmp_files/tmp.pgm >./mat/tmp_files/tmp.key'];
eval(command);
% Open tmp.key and check its header
g=fopen('./mat/tmp_files/tmp.key', 'r');
if(g==-1)
    error('Could not open file ./mat/tmp_files/tmp.key.');
end
